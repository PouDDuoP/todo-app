...
import { Project, Task, createProject, createTask } from '@shared/models/todo.model';
...
export class TodoService {
  ...
  addTask(title: string, description = ''): void {
  ...
  editTask(projectId: string, taskId: string, title: string, description: string): void {
    this.projects.update(projects =>
      projects.map(p =>
        p.id === projectId
          ? {
